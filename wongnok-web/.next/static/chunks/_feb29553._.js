...
const CardRecipe = (param)=>{
    let { name, imageUrl, description, difficulty, cookingDuration, user, favorite, rating, averageRating } = param;
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                typeof averageRating === 'number' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "absolute bottom-1 right-1 text-xs text-gray-600",
...
const Myfavorite = ()=>{
    ...
    const { mutateAsync: getRecipe, isPending: isRecipeLoading, isError: isRecipeError } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"])({
        ...
        onSuccess: {
            "Myfavorite.useMutation": (data)=>{
                var _data_total;
                const total = Number((_data_total = data === null || data === void 0 ? void 0 : data.total) !== null && _data_total !== void 0 ? _data_total : 0);
                if (Number(searchParams.get('page')) > Math.ceil(total / Number(searchParams.get('limit')))) {
                ...
                var _data_results;
                setRecipesData({
                    results: (_data_results = data === null || data === void 0 ? void 0 : data.results) !== null && _data_results !== void 0 ? _data_results : [],
                    total
                });
            }
        }["Myfavorite.useMutation"]
    ...
    const { mutateAsync: removeFavorite, isPending: isRemoving } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: {
            "Myfavorite.useMutation": (foodRecipeID)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$recipe$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DeleteFavorite"])(foodRecipeID)
        }["Myfavorite.useMutation"],
        onSuccess: {
            "Myfavorite.useMutation": (_res, foodRecipeID)=>{
                // Determine if this was the last item on the page (before update)
                const wasLastOnPage = recipesData.results.length === 1 && currentPage > 1;
                // Optimistically remove from UI
                setRecipesData({
                    "Myfavorite.useMutation": (prev)=>{
                        const newResults = prev.results.filter({
                            "Myfavorite.useMutation.newResults": (r)=>Number(r.id) !== Number(foodRecipeID)
                        }["Myfavorite.useMutation.newResults"]);
                ...
                // Notify other pages (e.g., home) to refresh favorite states
                ...
                // If page becomes empty and we’re not on the first page, go back one page
                if (wasLastOnPage) {
                ...
                // Otherwise just refetch current page to sync
    ...
    if (isRecipeLoading) return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "w-full flex justify-center items-center my-8",
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(Myfavorite, "kEQQqJhBK0Hb7f4zpJG4iNTMeF0=", false, function() {
    return [
...
//# sourceMappingURL=_feb29553._.js.map