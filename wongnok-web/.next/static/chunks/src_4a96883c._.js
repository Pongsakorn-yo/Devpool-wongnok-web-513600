...
api.interceptors.request.use(async (config)=>{
    console.log('Axios interceptor running...'); // Debug log
    try {
        if ("TURBOPACK compile-time truthy", 1) {
            ...
            if (session === null || session === void 0 ? void 0 : session.accessToken) {
                ...
                console.log('✅ Using session accessToken:', session.accessToken.substring(0, 50) + '...');
            } else {
                console.log('❌ No accessToken in session:', session);
            }
...
api.interceptors.response.use((response)=>response, async (error)=>{
    ...
    if (((_error_response = error.response) === null || _error_response === void 0 ? void 0 : _error_response.status) === 401) {
        ...
        if (session === null || session === void 0 ? void 0 : session.refreshToken) {
            try {
                const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post("".concat(("TURBOPACK compile-time value", "http://localhost:8082"), "/auth/refresh"), {
...
const createRecipe = async (data)=>{
    // Use direct backend URL instead of relying on baseURL
    const backendUrl = 'http://localhost:8082/api/v1/food-recipes';
    var _data_imageURL;
    const recipeDetails = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].post(backendUrl, {
        name: data.name,
        description: data.description,
        ingredient: data.ingredient,
        instruction: data.instruction,
