...
const baseURL = ("TURBOPACK compile-time truthy", 1) ? ("TURBOPACK compile-time value", "http://localhost") || '' : "TURBOPACK unreachable";
...
api.interceptors.request.use(async (config)=>{
    try {
        if ("TURBOPACK compile-time truthy", 1) {
            ...
            let session = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$auth$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getSession"])();
            if (!session) {
                await new Promise((r)=>setTimeout(r, 150));
                session = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$auth$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getSession"])();
            }
            const tokenToUse = ((_this = session) === null || _this === void 0 ? void 0 : _this.idToken) || ((_this1 = session) === null || _this1 === void 0 ? void 0 : _this1.accessToken);
            if (tokenToUse) {
                config.headers = config.headers || {};
                config.headers.Authorization = "Bearer ".concat(tokenToUse);
            }
        }
    } catch (error) {
...
api.interceptors.response.use((response)=>response, async (error)=>{
    ...
    if (((_error_response = error.response) === null || _error_response === void 0 ? void 0 : _error_response.status) === 401 && "object" !== 'undefined') {
        ...
        if (!onAuth) (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$auth$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["signIn"])('keycloak');
    }
...
const fetchRecipesByUser = async (userId)=>{
    try {
        // If userId not provided, fetch current user info first
        let uid = userId;
        if (!uid) {
            const me = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].get("/api/v1/users/");
            uid = me.data.id;
        }
        const recipes = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].get("/api/v1/users/".concat(uid, "/food-recipes"));
...
function MyProfile() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "MyProfile.useEffect": ()=>{
            if (status === 'unauthenticated') (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$auth$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["signIn"])();
        }
    }["MyProfile.useEffect"], [
        status
    ]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "MyProfile.useEffect": ()=>{
            const load = {
                "MyProfile.useEffect.load": async ()=>{
                    try {
                        const me = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$recipe$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getUser"])();
                        setNickName(me.nickName || '');
                        setImageUrl(me.imageUrl || '');
                        var _me_firstName, _me_lastName;
                        setName("".concat((_me_firstName = me.firstName) !== null && _me_firstName !== void 0 ? _me_firstName : '', " ").concat((_me_lastName = me.lastName) !== null && _me_lastName !== void 0 ? _me_lastName : '').trim());
                    } catch (e) {}
                }
            }["MyProfile.useEffect.load"];
            load();
        }
    }["MyProfile.useEffect"], []);
    const onSave = async ()=>{
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$recipe$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["UpdateUser"])({
            nickName,
            imageUrl
        });
    };
...
_s(MyProfile, "iu/+8+ygTjYWk44Wly7Ui7Vfyiw=", false, function() {
    return [
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$image$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                src: (data === null || data === void 0 ? void 0 : data.imageUrl) || "/wongnok-with-name-logo.png",
                                alt: "logo profile",
                                width: 152,
                                height: 152,
...
_s1(MyProfile, "1IuzOuB5ylJBFgLqBC8VmUxEJ2c=", false, function() {
    return [
...
//# sourceMappingURL=src_e7ef1a5c._.js.map